...
class DummyData {
    ...
    private val listOfParish = HomeModel("List of Parish", "Get parish mass tie and activities", R.drawable.ic_baseline_church_24)
    ...
    val homeList: ArrayList<HomeModel> = arrayListOf(parish, calendar, listOfParish, dailyReadings, catechism, simplePrayers)
